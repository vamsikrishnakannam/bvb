...
if(isset($_POST['submit']))
{
	...
	if(mysqli_num_rows($run))
	{
		...
		$message="Hi, $name<br>Activate your account <br> <a href='http://localhost/ereg/validate.php?token=$token'>Click here</a>";
		$headers="Content-type:text/html;charset=UTF-8";
		if($result['status']=='inactive')
		{
		if(mail($email,$subject,$message,$headers))
		{
			$_SESSION['msg']="Mail send to $email";
		}
		else
		{
	...
	{
		$error[]="Unable to send Email. Your account is already activated";
	}
...
<body style="background-image:url('loginbg.jpg'); color: black;">
  ...
  <div class="container-fluid">
	...
	<div class="form-group form">
		...
		<center><h4>Resend Activation Link</h4></center>
		<?php 
			if(isset($error))
				{
